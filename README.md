...
3. You'll need a GitHub API Token with `repo` and `user` scope created with option `Generate new token (classic)` from [here](https://github.com/settings/tokens) if you're running the action to get commit metrics
